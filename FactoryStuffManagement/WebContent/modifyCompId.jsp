            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="panel panel-info" style="position:absolute;left:55%; width:600px;height:400px;">
                        ...
                        <div class="panel-body">
                            <form method="post" role="form" action="ModifyRepertoryCompId">
                                        <div class="form-group">
											<p class="help-block">注意：本申请单仅供修改零件型号。</p>
                                            <label>仓库编码</label>
                                            <input name="wareId" class="form-control" type="text" required="required" readonly="readonly" value="${feedback1}"/>
                                            
                                        </div>
										<div class="form-group">
										    <label>零件型号</label>
										    <input name="compId" class="form-control" type="text" required="required" placeholder="${feedback2}"/>
										    <input type="hidden" name="origCompId" value="${feedback2}">
										</div>
