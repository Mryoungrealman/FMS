            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="panel panel-info" style="position:absolute;left:55%; width:600px;height:400px;">
                        ...
                        <div class="panel-body">
                            <form method="post" role="form" action="modifyRepertoryNum">
                                        <div class="form-group">
											<p class="help-block">注意：本申请单仅供修改物资数量。</p>
                                            <label>仓库编码</label>
										...
										<div class="form-group">
											<label>零件数量</label>
											<input name="num" class="form-control" type="text" required="required" placeholder="${feedback3}"/>
											<input type="hidden" name="origNum" value="${feedback3}">
